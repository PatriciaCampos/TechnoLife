...
as
begin
 insert into direccion_cliente ([id_cliente], [nombres], [apellidos], [informacion], [zip], [id_comuna], [direccion], [telefono], [celular]) 
 values (@id_cliente, @nombres, @apellidos, @informacion, @zip, @id_comuna, @direccion, @telefono, @celular)
end
GO
...
as
begin
insert into Producto ([cod_producto], [nombre_producto], [imagen], [tamano], [activo],[id_cate]) 
values (@codProducto, @nombreProducto, @imagen, @tamano,
 @activo,
 @idCate)
end
GO
...
as
update producto set cod_producto = @cod_producto, nombre_producto= @nombre_producto, imagen = @imagen, tamano=@tamano,activo=@activo, id_cate=@idCate
...
as
begin
 insert into sucursal ([nombre_sucursal]) values (@nombre_sucursal)
end
GO
